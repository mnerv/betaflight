...
# ---- HAL driver sources ----
set(_STDPERIPH_DIR "${_LIB_G4_DIR}/STM32G4xx_HAL_Driver")
...
# USB middleware
set(_USBCORE_DIR "STM32G4/Middlewares/ST/STM32_USB_Device_Library/Core")
set(_USBCDC_DIR  "STM32G4/Middlewares/ST/STM32_USB_Device_Library/Class/CDC")
set(_USBHID_DIR  "STM32G4/Middlewares/ST/STM32_USB_Device_Library/Class/HID")
set(_USBMSC_DIR  "STM32G4/Middlewares/ST/STM32_USB_Device_Library/Class/MSC")
...
if(BF_TARGET_MCU STREQUAL "STM32G474xx")
    list(APPEND BF_DEVICE_FLAGS -DSTM32G474xx)
    set(BF_LD_SCRIPT "${_STM32_DIR}/link/stm32_flash_g474.ld")
    set(BF_STARTUP_SRCS "${_STM32_DIR}/startup/startup_stm32g474xx.s")
    set(BF_MCU_FLASH_SIZE 512)
    # Save flash on 512 KB targets
    set(BF_OPTIMISE_SPEED "-O2")
else()
    message(FATAL_ERROR "Unknown STM32G4 MCU: ${BF_TARGET_MCU}")
endif()
...
set(BF_PLATFORM_INCLUDE_DIRS
    ...
    "${_LIB_G4_DIR}/CMSIS/Device/ST/STM32G4xx/Include"
)
...
set(BF_MCU_SRCS
    ...
    "${_STM32_DIR}/startup/system_stm32g4xx.c"
    # STM32_COMMON
...
set(BF_VCP_SRCS
    ...
    "${_STM32_DIR}/vcp_hal/usbd_conf_stm32g4xx.c"
